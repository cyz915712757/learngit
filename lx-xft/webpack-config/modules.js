...
const modules = {
  ...
  */
  ...
  { test: /\.woff\??.*$/, loader: 'file?name=static/fonts/[name]-[hash:8].[ext]&minetype=application/font-woff' },
  { test: /\.woff2\??.*$/, loader: 'file?name=static/fonts/[name]-[hash:8].[ext]&minetype=application/font-woff' },
  { test: /\.ttf\??.*$/, loader: 'file?name=static/fonts/[name]-[hash:8].[ext]&minetype=application/octet-stream' },
  { test: /\.eot\??.*$/, loader: 'file?name=static/fonts/[name]-[hash:8].[ext]' },
  { test: /\.svg\??.*$/, loader: 'file?name=static/fonts/[name]-[hash:8].[ext]&minetype=image/svg+xml' }
