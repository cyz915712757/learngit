...
const plugins = [
  ...
  // createHappyPlugin('font-ttf', ['file?name=static/fonts/[name]-[hash:8].[ext]&minetype=application/octet-stream']),
  // createHappyPlugin('font-eot', ['file?name=static/fonts/[name]-[hash:8].[ext]']),
  // createHappyPlugin('font-svg', ['file?name=static/fonts/[name]-[hash:8].[ext]&minetype=image/svg+xml']),
  // createHappyPlugin('font-woff', ['file?name=static/fonts/[name]-[hash:8].[ext]&minetype=application/font-woff']),
  // createHappyPlugin('font-woff2', ['file?name=static/fonts/[name]-[hash:8].[ext]&minetype=application/font-woff']),
